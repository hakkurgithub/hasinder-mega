...
export default function Panel() {
  ...
  return (
    <main className="min-h-screen bg-gray-900 text-white p-8">
      <h1 className="text-3xl font-bold text-yellow-500 mb-4 text-center">TİB Kullanıcı Paneli</h1>
      <p className="text-center mb-8 text-gray-400">Yeni talep oluşturun</p>
      ...
      <div className="max-w-2xl mx-auto bg-gray-800 p-6 rounded-lg">
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-yellow-600 hover:bg-yellow-500 text-white font-bold py-3 rounded"
          >
