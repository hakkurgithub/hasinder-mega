...
export default function TIB_HUB_FINAL(){
  ...
  return(
    <div style={{padding:'40px',background:'#0f172a',minHeight:'100vh',color:'#f8fafc',textAlign:'center'}}>
      <h1 style={{color:'#fbbf24'}}>TIB HUB v11.0 - AKTIF</h1>
      <p>Fabrika artik yayinda. Sistemsel cakismalar giderildi.</p>
      <div style={{marginTop:'30px',background:'#1e293b',padding:'20px',borderRadius:'15px'}}>
