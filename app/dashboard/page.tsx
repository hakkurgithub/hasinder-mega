...
<h1 style={{color:'#1B365D'}}>TIB FINAL DASHBOARD v10.1</h1>
<p>Otomasyon Tamamlandi. Icraat Basliyor.</p>
<button onClick={async()=>{await sb.from('trades').insert([{title:'SABAH OPERASYONU',amount:'5M TL',status:'OK'}]);get();}} style={{padding:'20px',background:'#1B365D',color:'#D4AF37',fontWeight:'bold',borderRadius:'15px',cursor:'pointer'}}>+ TEST ILANI EKLE</button>
